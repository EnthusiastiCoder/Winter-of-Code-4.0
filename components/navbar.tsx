    ...
    return (
        <nav className="z-40 sticky flex-col flex w-full top-0 gap-[1%]">
            <div className="flex w-full justify-center h-full pt-[calc(0.5%+8px)] gap-[5%] bg-black pb-[8px]">
                ...
                <Link href="/" className="text-scale-35-5 w-[14%] absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] sm:translate-y-[-40%] flex justify-center text-brand font-kleemax">
                    WOC
                </Link>
            ...
            <Image className="flex sm:0" src={navline} alt="navline"/>
        </nav>
